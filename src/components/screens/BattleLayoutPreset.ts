...
export const battleActiveLayoutConfig = createBattleLayoutConfig(
  battleActiveDesktopLayoutOverrides,
);

export const battleActiveTabletLayoutConfig = createBattleLayoutConfig(
  battleActiveTabletLayoutOverrides,
);

export const battleActiveMobileLayoutConfig = createBattleLayoutConfig(
  battleActiveMobileLayoutOverrides,
);
