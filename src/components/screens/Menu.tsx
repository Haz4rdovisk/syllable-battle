      ...
      <div className="relative z-10 w-full max-w-[68rem]">
        ...
        <div className="paper-panel relative z-10 overflow-hidden rounded-[2rem] border-[4px] border-[#4b3527]/25 px-4 py-5 shadow-[0_35px_80px_rgba(0,0,0,0.16)] [@media(pointer:coarse)_and_(max-height:480px)]:min-h-[calc(100dvh-20px)] [@media(pointer:coarse)_and_(max-height:480px)]:px-3 [@media(pointer:coarse)_and_(max-height:480px)]:py-3.5 sm:px-7 sm:py-7">
          ...
          <div className="relative flex flex-col gap-6 [@media(pointer:coarse)_and_(max-height:480px)]:gap-3.5">
            ...
            <div className="rounded-[1.9rem] border border-[#d8c9b0] bg-white/36 p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.8)] [@media(pointer:coarse)_and_(max-height:480px)]:mt-3.4 [@media(pointer:coarse)_and_(max-height:480px)]:mx-[0.95rem] [@media(pointer:coarse)_and_(max-height:480px)]:w-auto [@media(pointer:coarse)_and_(max-height:480px)]:rounded-[1.3rem] [@media(pointer:coarse)_and_(max-height:480px)]:px-2.75 [@media(pointer:coarse)_and_(max-height:480px)]:pt-2.75 [@media(pointer:coarse)_and_(max-height:480px)]:pb-4.25 lg:ml-[20px] sm:p-5">
