          ...
          <div className="relative flex flex-col gap-6 [@media(pointer:coarse)_and_(max-height:480px)]:gap-3.5">
            <div className="flex flex-col items-center text-center">
              ...
              >
                ...
                <h1 className="relative font-serif text-[3.3rem] font-black uppercase leading-[0.86] text-amber-950 drop-shadow-[0_2px_0_rgba(255,248,220,0.45)] [text-shadow:0_0_18px_rgba(238,196,94,0.18),0_4px_14px_rgba(214,165,63,0.16)] [@media(pointer:coarse)_and_(max-height:480px)]:text-[2.55rem] [@media(pointer:coarse)_and_(max-height:480px)]:leading-none sm:text-[4.8rem] lg:text-[5.7rem]">
            ...
            <div className="rounded-[1.9rem] border border-[#d8c9b0] bg-white/36 p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.8)] [@media(pointer:coarse)_and_(max-height:480px)]:mx-[0.95rem] [@media(pointer:coarse)_and_(max-height:480px)]:w-auto [@media(pointer:coarse)_and_(max-height:480px)]:rounded-[1.3rem] [@media(pointer:coarse)_and_(max-height:480px)]:p-2.75 lg:ml-[20px] sm:p-5">
              <div className="grid gap-4 [@media(pointer:coarse)_and_(max-height:480px)]:gap-2.5 sm:grid-cols-2">
                <CabinetButton
                  label="Jogar Solo"
