export type BattleCardStackPresetId =
  | "arcane"
  | "sunforge"
  | "ember"
  | "jade";

export const DEFAULT_BATTLE_CARD_STACK_PRESET_ID: BattleCardStackPresetId =
  "arcane";

export const battleCardStackPresetOptions: Array<{
...
type BattleCardStackSurfaceClasses = {
...
type BattleCardStackVisualPresetDefinition = {
  cardBack: BattleCardStackSurfaceClasses;
  pile: Record<"deck" | "target", BattleCardStackSurfaceClasses>;
  labelClassName: string;
  countBadgeClassName: string;
  emptyStateClassName: string;
};

const battleCardStackVisualPresets: Record<
  BattleCardStackPresetId,
  BattleCardStackVisualPresetDefinition
> = {
  arcane: {
    cardBack: {
      layerClassName:
...
export const getBattleCardStackVisualPreset = (
  presetId: BattleCardStackPresetId,
) => battleCardStackVisualPresets[presetId];
